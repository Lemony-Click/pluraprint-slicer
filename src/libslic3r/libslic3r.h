...
#define SLIC3R_APP_FULL_NAME "Pluraprint Slicer"
#define GCODEVIEWER_APP_NAME "Pluraprint Slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "PluraprintSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Pluraprint Slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
