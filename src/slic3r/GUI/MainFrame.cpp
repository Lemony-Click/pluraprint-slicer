...
#ifdef __APPLE__
class PluraprintSlicerTaskBarIcon : public wxTaskBarIcon
{
public:
    PluraprintSlicerTaskBarIcon(wxTaskBarIconType iconType = wxTBI_DEFAULT_TYPE) : wxTaskBarIcon(iconType) {}
...
#else // _WIN32
    return wxIcon(Slic3r::var("PluraprintSlicer_128px.png"), wxBITMAP_TYPE_PNG);
#endif // _WIN32
}
...
*/
    ...
    case GUI_App::EAppMode::Editor:
        m_taskbar_icon = std::make_unique<PluraprintSlicerTaskBarIcon>(wxTBI_DOCK);
        m_taskbar_icon->SetIcon(wxIcon(Slic3r::var("PluraprintSlicer-mac_256px.ico"), wxBITMAP_TYPE_ICO), "Pluraprint Slicer");
        break;
    ...
    m_print_option_btn->Bind(wxEVT_BUTTON, [this](wxCommandEvent& event)
        {
            ...
            if (wxGetApp().preset_bundle
                ...
                //Pluraprint Slicer Buttons

                // Compute support flags BEFORE creating buttons,
                // so we only create buttons that will actually be used.
...
static wxMenu* generate_help_menu()
{
    ...
    // Report a bug
    //append_menu_item(helpMenu, wxID_ANY, _L("Report Bug(TODO)"), _L("Report a bug of Pluraprint Slicer"),
    //    [](wxCommandEvent&) {
    //        //TODO
    //    });
...
void MainFrame::init_menubar_as_editor()
{
    ...
    //auto preference_item = new wxMenuItem(parent_menu, PluraprintSlicerMenuPreferences + bambu_studio_id_base, _L("Preferences") + "\t" + ctrl + ",", "");
#else
...
#ifdef __APPLE__
    wxString about_title = wxString::Format(_L("&About %s"), SLIC3R_APP_FULL_NAME);
    //auto about_item = new wxMenuItem(parent_menu, PluraprintSlicerMenuAbout + bambu_studio_id_base, about_title, "");
        //parent_menu->Bind(wxEVT_MENU, [this, bambu_studio_id_base](wxEvent& event) {
        //    switch (event.GetId() - bambu_studio_id_base) {
        //        case PluraprintSlicerMenuAbout:
        //            Slic3r::GUI::about();
        //            break;
        //        case PluraprintSlicerMenuPreferences:
        //            CallAfter([this] {
        //                PreferencesDialog dlg(this);
        //                dlg.ShowModal();
        //#if ENABLE_GCODE_LINES_ID_IN_H_SLIDER
...
#else
    SetIcon(wxIcon(var("PluraprintSlicer_128px.png"), wxBITMAP_TYPE_PNG));
#endif // _WIN32
