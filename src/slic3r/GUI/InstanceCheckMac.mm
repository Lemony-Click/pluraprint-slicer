...
-(void)add_observer:(NSString *)version_hash
{
	...
	//NSString *nsver = @"OtherPluraprintSlicerInstanceMessage" + version_hash;
	NSString *nsver = [NSString stringWithFormat: @"%@%@", @"OtherPluraprintSlicerInstanceMessage", version_hash];
	...
	NSString *nsver2 = [NSString stringWithFormat: @"%@%@", @"OtherPluraprintSlicerInstanceClosing", version_hash];
...
void send_message_mac(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherPluraprintSlicerInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherPluraprintSlicerInstanceMessage", nsver];
...
void send_message_mac_closing(const std::string &msg, const std::string &version)
{
	...
	//NSString *nsver = @"OtherPluraprintSlicerInstanceMessage" + [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *nsver = [NSString stringWithCString:version.c_str() encoding:[NSString defaultCStringEncoding]];
	NSString *notifname = [NSString stringWithFormat: @"%@%@", @"OtherPluraprintSlicerInstanceClosing", nsver];
	[[NSDistributedNotificationCenter defaultCenter] postNotificationName:notifname object:nil userInfo:[NSDictionary dictionaryWithObject:nsmsg forKey:@"data"] deliverImmediately:YES];
}
