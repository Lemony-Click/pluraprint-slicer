...
// Following function saves current PluraprintSlicer version into app config.
...
static std::string generate_system_info_json()
{
    ...
    pt::ptree data_node;
    data_node.put("PluraprintSlicerVersion", SLIC3R_VERSION);
        ...
        wxDEFAULT_DIALOG_STYLE)
{
    ...
    wxString html = GUI::format_wxstr(
            ...
            "<table><tr><td>"
            "<img src = \"" + resources_dir() + "/images/PluraprintSlicer_192px.png\" />"
            "</td><td align=\"left\">"
            + text0 + "<br / ><br / >"
            + text1 + "<br /><br />"
            "</td></tr></table>"
