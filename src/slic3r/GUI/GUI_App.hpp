...
enum PluraprintSlicerMenuIDs {
  PluraprintSlicerMenuAbout,
  PluraprintSlicerMenuPreferences,
};
...
public:
    ...
    std::string logo_name() const { return is_editor() ? "PluraprintSlicer" : "PluraprintSlicer-gcodeviewer"; }
